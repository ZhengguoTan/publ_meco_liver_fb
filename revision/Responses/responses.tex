...
%FIXME: Improvement in manuscript?
...
\hspace{1em} Please refer to Figure 10. %FIXME: reduced to Scheinder et al. ???
...
However, we observed in this study that in cases of incomplete breath hold 	%FIXME How known?
(Volunteer \#1, Patients \#8 \& \#9), 
the reference sequence suffers from underestimated $R_2^*$, 
...
\hspace{1em} Initialization in non-convex inverse problems is not a trivial task. %FIXME: needs better answer
...
We have corrected this in the manuscript.  %FIXME What?
