...
which fits well for obese patients (Patient \#1 to \#9). %FIXME
...
%	\begin{threeparttable}
	...
	\begin{tabular}{m{0.17\columnwidth} m{0.06\columnwidth} m{0.08\columnwidth} m{0.17\columnwidth} m{0.17\columnwidth} m{0.20\columnwidth}}
		...
		% extra patients
		Patient \#10  & 62 & M & 202 & 100 & 24.5 \\ % 0045
		Patient \#11  & 67 & M & 176 &  99 & 32.0 \\ % 0047
		Patient \#12  & 26 & F & 178 & 180 & 56.8 \\ % 0057
		Patient \#13  & 69 & M & 191 & 134 & 36.7 \\ % 0058
		Patient \#14  & 61 & M & 173 & 114 & 38.1 \\ % 0059
		Patient \#15  & 51 & M & 169 & 101 & 35.4 \\ % 0060
		\bottomrule
	\end{tabular}
%	\begin{tablenotes}
%		\item[a] BMI was calculated via \url{https://www.nhlbi.nih.gov/health/educational/lose_wt/BMI/bmicalc.htm}.
%	\end{tablenotes}
%	\end{threeparttable}
\end{table}
...
scans. Patient \#9 has hepatic steatosis as confirmed via %FIXME changes
