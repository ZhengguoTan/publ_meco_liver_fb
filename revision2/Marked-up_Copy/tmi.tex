...
Therefore, \mbox{\cref{FIG:SENS}} displays the first five coil sensitivity maps 
of the first respiratory bin from the joint estimation method and ESPIRiT, respectively. 
Since coil sensitivity maps from ESPIRiT are inherently normalized, 
normalization is also done for the coil sensitivity maps from joint estimation. 
Both methods render similar coil sensitivity maps.}
